...
class Program
{
    ...
    public class Equipment
    {
        ...
        public string Power { get; set; } // Потужність обладнання
    ...
    static void OutputData()
    {
        ...
        if (File.Exists(@"C://Temp//pobutova technica.txt"))
        {
            ...
            foreach (Equipment equipment in equipmentList)
            {
                ...
                Console.WriteLine($"Назва: {equipment.Name}, Ціна: {equipment.Price}, Потужність: {equipment.Power}, Порядковий номер: {OrdinalNumber}");
            }
        }
        else
        {
    ...
    //4 Видалення даних видаляє з підсказкою NORM
    ...
    //5 Функція виведення найменшої чи найбільшої ціни та суми  NORM
    ...
    static void OperationsWithData()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("3. Знайти суму");
            ...
            case 2:
                {
                    ...
                    {
                        Console.WriteLine($"Назва: {equipment.Name}, Ціна: {equipment.Price}, Потужність: {equipment.Power}, Порядковий номер: {equipment.OrdinalNumber}");
                    }
